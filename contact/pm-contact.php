    ...
    <body class="is-preload">
		...
		<section class="contact-us">
            <div class="training-inner">
                <div class="row"> 
                    <div class="col-lg-6 left-col-pm">
                        <div class="contact-us-left">
                            <div class="container">
                                <h1>Project Management</h1>    
        
                                <p>
                                A four-month training program where trainees are assisted to register for certification exams within first week of course start date and prepared to write their professional exams by end of the training period. Trainees are placed on internship and work on live projects to get a hands-on experience as a Project/Product manager.
                                </p>
                            </div>
